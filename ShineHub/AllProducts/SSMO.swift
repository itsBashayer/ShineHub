...
struct SSMO: View {
    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            Text("moisturizer For Sensitive Skin :")
                .font(.system(size: 26))
                            ...
                            .overlay {
                                HStack{
                                    ...
                                    VStack(alignment: .leading) {
                                         Text("Bioderma Sebium")
                                                .font(.title)
                                                .fontWeight(.medium)
                                                .foregroundColor(Color.black)
                                        
                                        Text("A lightweight relieving moisturizer for acne-prone skin Formulated ")//LargeText
                                            .font(.callout)
                        ...
                        Rectangle()
                            ...
                            .overlay {
                                HStack{
                                    ...
                                    VStack(alignment: .leading) {
                                       Text("CeraVe Moisturizing")
                                                .font(.title)
                                                .fontWeight(.medium)
                                                .foregroundColor(Color.black)
                                        
                                        Text(" Hyaluronic Acid Moisturizer with CeramideS and is quickly absorbed to smooth skin . ")//LargeText
                                            .font(.callout)
                                            .foregroundColor(.gray)
                                        // Divider()
                                        // Divider()
                        ...
                        Rectangle()
                            ...
                            .overlay {
                                HStack{
                                    ...
                                    VStack(alignment: .leading) {
                                        Text("QV moisturizing")
                                                .font(.title)
                                                .fontWeight(.medium)
                                                .foregroundColor(Color.black)
                                        
                                        Text("protective moisturizing cream with 5 moisturizing helps to hydrate dry areas  ")//LargeText
                                            .font(.callout)
                                            .foregroundColor(.gray)
                                        // Divider()
                                        // Divider()
