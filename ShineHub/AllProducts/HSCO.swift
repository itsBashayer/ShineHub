...
struct HSCO: View {
    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            Text("Conditioners For Straight Hair :")
                .font(.system(size: 26))
                            ...
                            .overlay {
                                HStack{
                                    ...
                                    VStack(alignment: .leading) {
                                        ...
                                        Text("Unleash keratin power for smoother, frizz-tamed straight locks")//LargeText
                                            .font(.callout)
                                ...
                                HStack{
                                    ...
                                    VStack(alignment: .leading) {
                                      Text("HASK Keratin")
                                        ...
                                        Text("Conditioner For Straight Hair")
                                            .font(.callout)
                                            .foregroundColor(.gray)
                                        // Divider()
                                    }
                                ...
                                HStack{
                                    ...
                                    VStack(alignment: .leading) {
                                       Text("John Masters")
                                        ...
                                        Text("Adds shine, controls frizz for effortlessly styled straight hair ")//LargeText
                                            .font(.callout)
                                            .foregroundColor(.gray)
                                        // Divider()
                                        // Divider()
                            ...
                            .overlay {
                                HStack{
                                    ...
                                    VStack(alignment: .leading) {
                                        ...
                                        Text("Versatile styling for flawless, polished straight hair. Smooth, volumize, and condition with ease ")//LargeText
                                            .font(.callout)
                                            .foregroundColor(.gray)
                                        // Divider()
                                        // Divider()
